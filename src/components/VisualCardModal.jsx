...
export default function VisualCardModal({ isOpen, onClose, plan }) {
  ...
  const renderCardToCanvas = () => {
    ...
    const drawCard = (productImg) => {
      ...
      // Dibujar imagen del producto si existe
      if (productImg) {
      ...
      const cardHeight = productImg ? 480 : 560;
      ...
      const cuotasY = cardY + (productImg ? 300 : 345);
      ...
      ctx.fillText('CUOTA 1 A 7:', 135, cuotasY + 50);

      ctx.fillStyle = '#ff9f1c';
      ctx.font = '900 48px "Outfit", sans-serif';
      ctx.fillText(formatMoney(plan.quote1to7), 135, cuotasY + 110);
      ctx.fillStyle = 'rgba(255, 255, 255, 0.5)';
      ctx.font = '500 18px "Plus Jakarta Sans", sans-serif';
      ctx.fillText('/ mes (suscripción diluida)', 135, cuotasY + 140);
      ...
      ctx.fillStyle = 'rgba(255, 255, 255, 0.7)';
      ctx.font = '700 22px "Plus Jakarta Sans", sans-serif';
      ctx.fillText('CUOTA 8 EN ADELANTE:', 595, cuotasY + 50);

      ctx.fillStyle = '#2ec4b6';
      ctx.font = '900 48px "Outfit", sans-serif';
      ctx.fillText(formatMoney(plan.quote8onwards), 595, cuotasY + 110);
      ctx.fillStyle = 'rgba(255, 255, 255, 0.5)';
      ctx.font = '500 18px "Plus Jakarta Sans", sans-serif';
      ctx.fillText('/ mes (cuota reducida)', 595, cuotasY + 140);

      // 5. Destacado Beneficio Ganador (Banner Dorado)
      const benY = cuotasY + 210;
